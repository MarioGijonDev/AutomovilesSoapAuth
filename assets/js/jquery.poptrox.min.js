	...
	(e.fn.poptrox_disableSelection = function () {
		...
		(e.fn.poptrox = function (o) {
			function t() {
				...
				x
					.css("min-width", r.popupWidth)
					.css("min-height", r.popupHeight),
			...
			if (
				...
				m.length > 0 &&
					...
					r.popupCaptionTextSize &&
						m.css("font-size", popupCaptionTextSize)),
				C.length > 0 &&
					...
					b
						...
						.on("startSpinning", function (o) {
							...
							t
								...
								.css(
									"color",
									r.popupTextColor ? r.popupTextColor : ""
								)
								.on("xfin", function () {
			...
			return (
				...
				x
					...
					.on("poptrox_reset", function () {
						t(),
							x
								.data("width", r.popupWidth)
								.data("height", r.popupHeight),
